  ...
  methods: {
    authenticate: {
      ...
      method(
        ...
        roleProof
          .calculateRoot(privateAuthArgs.roleHash)
          .assertEquals(publicInput.roleStoreCommitment);
        userProof
          .calculateRoot(privateAuthArgs.userHash)
          .assertEquals(publicInput.userStoreCommitment);
      },
    },
    /*authorize: {
